...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.JOINT_POS_BIMANUAL_MOBILE]:
        raise ValueError(f"Cannot load `{dataset_name}`; only EEF_POS & EEF_R6 & JOINT_POS_BIMANUAL_MOBILE actions supported!")
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.JOINT_POS_BIMANUAL_MOBILE:
        dataset_kwargs["absolute_action_mask"] = [False] * 16
